...
#include "Flight_Quaterions.h"

// Formula to convert a Euler angle in degrees to a quaternion rotation
FQuat UFlight_Quaterions::Euler_To_Quaternion(FRotator Current_Rotation)
{
...
void UFlight_Quaterions::SetWorldRotationQuat(USceneComponent* SceneComponent, const FQuat& Desired_Rotation)
{
    if (SceneComponent)
    {
...
void UFlight_Quaterions::SetRelativeRotationQuat(USceneComponent* SceneComponent, const FQuat& Desired_Rotation)
{
    if (SceneComponent)
    {
...
void UFlight_Quaterions::AddLocalRotationQuat(USceneComponent* SceneComponent, const FQuat& Delta_Rotation)
{
    if (SceneComponent)
    {
...
void UFlight_Quaterions::SetActorWorldRotationQuat(AActor* Actor, const FQuat& Desired_Rotation)
{
    if (Actor)
    {
...
void UFlight_Quaterions::SetActorRelativeRotationQuat(AActor* Actor, const FQuat& Desired_Rotation)
{
    if (Actor)
    {
...
void UFlight_Quaterions::AddActorLocalRotationQuat(AActor* Actor, const FQuat& Delta_Rotation)
{
    if (Actor)
    {
